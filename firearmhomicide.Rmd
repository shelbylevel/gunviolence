...
```{r census geometry data, include=FALSE}
...
## U.S. Firearm Homicide Deaths by State Percent Change, 2013-2017 to 2018-2022

```{r pct change 2013-17 to 2018-22 bar chart}
...
homicide %>% 
  ...
  DT::datatable(
    ., 
    caption = "Rate of Firearm Homicide Deaths per 100,000 Population",
    rownames = FALSE, 
    colnames = c(
      "State", "Deaths", "Total Population", "Rate", "State Rank"
      ),
